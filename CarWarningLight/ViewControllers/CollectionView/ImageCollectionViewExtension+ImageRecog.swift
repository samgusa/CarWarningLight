//
//  ImageCollectionViewExtension+ImageRecog.swift
//  CarWarningLight
//
...
//scrolling top top, detectImg
extension ImageCollectionViewController {
    
    func detectImg(image: CIImage) {
        SwiftSpinner.show("DOESN'T REPLACE A VISIT TO A MECHANIC")
        let url = MainCarImg4.urlOfModelInThisBundle
        let model = try! MainCarImg4(contentsOf: url, configuration: MLModelConfiguration())
